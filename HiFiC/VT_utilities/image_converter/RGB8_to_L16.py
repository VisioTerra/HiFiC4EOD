    ...
    for filename in tqdm(files, desc="Conversion en cours", unit="image"):
        if filename.endswith(".png") or filename.endswith(".jpg"):
            ...
            if not os.path.exists(output_path):
                ...
                l_array = (new_r + new_b + new_g)*255
                # Convert the arrays back to Image objects
                l = Image.fromarray(l_array.astype('uint16'))
...
datasets = {"OID7_RGB8_1000", "OID7_RGB8_10000"} #datasets = {"OID7_RGB8_100", "OID7_RGB8_1000", "OID7_RGB8_10000"}
